...
const Rpx = require('../../static/mp-weixin/simplemap/utils/convert').rpxToPx;
const SimpleMap = require('../../static/mp-weixin/simplemap/simplemap').SimpleMap;
const Layer = require('../../static/mp-weixin/simplemap/layers/Layer');
const Widget = require('../../static/mp-weixin/simplemap/widgets/Widget');

const util = require('../../static/mp-weixin/utils/util.js');
...
Component({
  ...
  methods: {
    ...
    onMapReady: function (res) {
      ...
      // 配置缩放按钮
      const btnZoomIn = new Widget.ImageButton(map, map.width - Rpx(140), map.height - Rpx(336), '../../static/mp-weixin/resource/zoom-in.png', Rpx(36), Rpx(36));
      const btnZoomOut = new Widget.ImageButton(map, map.width - Rpx(140), map.height - Rpx(220), '../../static/mp-weixin/resource/zoom-out.png', Rpx(36), Rpx(36));
      ...
      // 配置并添加指北针图标
      const image = new Widget.Image(map, '../../static/mp-weixin/resource/north.png', 16, 16, 32, 32);
      map.addWidget(image);
